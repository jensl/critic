...
single_changeset = frontend.json(
    ...
    params={ "repository": 1,
             "commit": TO_SHA1},
    expect={ "files": [{ "path": "testing/__init__.py", "id": int },
                       { "path": "testing/repository.py", "id": int },
                       { "path": "testing/virtualbox.py", "id": int }],
             "type": "direct",
             "to_commit": int,
             "id": int,
             "from_commit": int,
...
frontend.json(
    ...
    params={ "repository": "critic",
             "from": FROM_SHA1,
             "to": TO_SHA1 },
    expect={ "files": [{ "path": "src/auth/accesscontrol.py", "id": int },
                       { "path": "src/operation/__init__.py", "id": int },
                       { "path": "src/operation/createreview.py", "id": int },
                       { "path": "src/page/createreview.py", "id": int },
                       { "path": "src/page/utils.py", "id": int },
                       { "path": "testing/__init__.py", "id": int },
                       { "path": "testing/repository.py", "id": int },
                       { "path": "testing/virtualbox.py", "id": int }],
             "type": "custom",
             "to_commit": int,
