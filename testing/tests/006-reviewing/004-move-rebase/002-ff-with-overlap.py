...
def test1(work):
    """Basic fast-forward move rebase with overlapping work."""

    review = Review(work, "alice", "039-move-rebase/002-ff-with-overlap")
    review.addFile(nonsense="039-move-rebase/002-ff-with-overlap/nonsense.txt")
        ...
        expect=partial_json(
            {
                "partitions": [
                    ...
                    {
                        "commits": commit_ids(reversed(review.sha1s[1:4])),
                        "rebase": None,
                    },
                ],
                "linked": {
