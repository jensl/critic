...
import { loadRepositories } from "../actions/repository"
...
const BrowseRepositories: FunctionComponent = () => {
  ...
  return (
    <Paper>
      ...
      <RepositoryList repositoryIDs={repositories.keys()} />
    </Paper>
  )
}

export default Registry.add("Browse.Repositories", BrowseRepositories)
