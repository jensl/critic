...
snapshots['test_changeset websocket messages'] = {
    'publish': [
        {
            'channel': [
                'repositories'
            ...
            'message': {
                'action': 'created',
                'object_id': Anonymous(RepositoryId='test_changeset'),
                'resource_name': 'repositories'
            }
        },
        {
            'channel': [
                "repositories/<Anonymous(RepositoryId='test_changeset')>"
            ],
            'message': {
                'action': 'modified',
                'object_id': Anonymous(RepositoryId='test_changeset'),
        ...
        },
        {
            ...
            'message': {
                ...
                'repository_id': Anonymous(RepositoryId='test_changeset'),
        ...
        },
        {
            ...
            'message': {
                'action': 'created',
                'object_id': Anonymous(ChangesetId='created'),
        ...
        {
            'channel': [
                'changesets/<Anonymous(ChangesetId=Variable(2))>'
            ],
            'message': {
                'action': 'modified',
                'object_id': Anonymous(ChangesetId=Variable(2)),
                'resource_name': 'changesets',
                'updates': {
                    'completion_level': [
                        'analysis',
        ...
        {
            'channel': [
                "changesets/<Anonymous(ChangesetId='created')>"
            ],
            'message': {
                'action': 'modified',
                'object_id': Anonymous(ChangesetId='created'),
