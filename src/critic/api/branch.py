...
from typing import Literal, Optional, Sequence, FrozenSet, cast, overload
...
@overload
async def fetch(critic: api.critic.Critic, branch_id: int = None, /,) -> Branch:
    ...
...
async def fetch(
    ...
    *,
    ...
    from .impl import branch as impl

    return await impl.fetch(critic, branch_id, repository, name)
...
async def fetchAll(
    ...
    *,
    repository: api.repository.Repository = None,
    created_by: api.user.User = None,
    updated_by: api.user.User = None,
