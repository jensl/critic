...
from .create import CreateRepositorySetting


class ModifyRepositorySetting(Modifier[api.repositorysetting.RepositorySetting]):
    ...
    async def create(
        ...
        return ModifyRepositorySetting(
            transaction,
            await CreateRepositorySetting.make(
                transaction, repository, scope, name, value
            ),
        )
