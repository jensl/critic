...
class CommitMessageLocation(Location):
    ...
    def make(
        ...
        from .impl import comment as impl

        return impl.makeCommitMessageLocation(critic, first_line, last_line, commit)
...
class FileVersionLocation(Location):
    ...
    async def make(
        ...
        return await impl.makeFileVersionLocation(
...
async def fetch(critic: api.critic.Critic, comment_id: int) -> Comment:
    ...
    return await impl.fetch(critic, comment_id)
...
async def fetchMany(
    ...
    return await impl.fetchMany(critic, list(comment_ids))
...
async def fetchAll(
    ...
    *,
    ...
    changeset: api.changeset.Changeset = None,
    commit: api.commit.Commit = None,
    files: Iterable[api.file.File] = None,
    addressed_by: Union[api.commit.Commit, api.branchupdate.BranchUpdate] = None,
) -> Sequence[Comment]:
